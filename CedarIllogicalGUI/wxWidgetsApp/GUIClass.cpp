...
GUIClass::GUIClass( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, wxT("CedarIllogical: Logic simulation based on vibes. Created by Nick Stokes"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	simulationspace = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 460,130 ), wxTE_MULTILINE );
	simulationspace->SetFont( wxFont( 7, 74, 90, 90, false, wxT("Courier New") ) );
