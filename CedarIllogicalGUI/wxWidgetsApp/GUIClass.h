...
class GUIClass : public wxFrame 
{
	...
	public:
		...
		GUIClass( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("CedarIllogical"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,300 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
